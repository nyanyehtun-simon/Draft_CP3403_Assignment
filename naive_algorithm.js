...
var ProbalityDenominator = function (Data, Evidence, Class, ClassifierOutcome) {
    var count = 0;
    ...
    evidenceAttribute_List.forEach(function (element) {
        instanceofFrequency = InstanceofFrequency(Data, Evidence, element, Class, ClassifierOutcome);
